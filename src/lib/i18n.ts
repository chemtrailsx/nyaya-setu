...
const kn: UIStrings = {
  listen: "ಕೇಳಿ",
  progressTitle: "ಪ್ರಗತಿ",
  progReading: "ನಿಮ್ಮ ದಾಖಲೆಯನ್ನು ಓದಲಾಗುತ್ತಿದೆ",
  progFinding: "ನಿಮಗೆ ಅನ್ವಯಿಸುವ ಕಾನೂನನ್ನು ಹುಡುಕಲಾಗುತ್ತಿದೆ",
  progPreparing: "ನಿಮ್ಮ ಯೋಜನೆ ಮತ್ತು ಫಾರ್ಮ್‌ಗಳನ್ನು ಸಿದ್ಧಪಡಿಸಲಾಗುತ್ತಿದೆ",
  progSettingUp: "ನಿಮ್ಮ ಪ್ರಕರಣವನ್ನು ಸಿದ್ಧಪಡಿಸಲಾಗುತ್ತಿದೆ",
  progConnecting: "ನಿಮ್ಮನ್ನು ಉಚಿತ ವಕೀಲರೊಂದಿಗೆ ಸಂಪರ್ಕಿಸಲಾಗುತ್ತಿದೆ",
  pleaseWait: "ದಯವಿಟ್ಟು ಸ್ವಲ್ಪ ನಿರೀಕ್ಷಿಸಿ…",
  docTitle: "ದಾಖಲೆಯಲ್ಲಿ ಏನಿದೆ",
  planTitle: "ಕ್ರಿಯಾ ಯೋಜನೆ",
  whereToGo: "ಎಲ್ಲಿಗೆ ಹೋಗಬೇಕು",
  whomToMeet: "ಯಾರನ್ನು ಭೇಟಿಯಾಗಬೇಕು",
  howToReach: "ಹೇಗೆ ತಲುಪಬೇಕು",
  whoToContact: "ಯಾರನ್ನು ಸಂಪರ್ಕಿಸಬೇಕು",
  whatToFile: "ಏನನ್ನು ಸಲ್ಲಿಸಬೇಕು",
  fee: "ಶುಲ್ಕ",
  openInMaps: "ನಕ್ಷೆಯಲ್ಲಿ ತೆರೆಯಿರಿ",
  actWithin: (n) => `${n} ದಿನಗಳೊಳಗೆ ಕ್ರಮ ಕೈಗೊಳ್ಳಿ — ಈ ಗಡುವನ್ನು ತಪ್ಪಿಸಿದರೆ ನಿಮ್ಮ ಪ್ರಕರಣ ತಡೆಯಾಗಬಹುದು`,
  nalsaChip: "NALSA ಉಚಿತ ಸಹಾಯ",
  docsTitle: "ಮೊದಲು ಈ ದಾಖಲೆಗಳನ್ನು ಸಂಗ್ರಹಿಸಿ",
  docsIntro: "ಸಲ್ಲಿಸುವ ಮೊದಲು ಇವುಗಳನ್ನು ಸಂಗ್ರಹಿಸಿ. ಯಾವುದಾದರೂ ಇಲ್ಲದಿದ್ದರೆ, ಇಲ್ಲಿ ಮಾಡಿಸಿಕೊಳ್ಳಿ.",
  formsTitle: (n) => `ಭರ್ತಿ ಮಾಡಬೇಕಾದ ಫಾರ್ಮ್‌ಗಳು (${n})`,
  fillByVoice: "ಮಾತನಾಡಿ ಭರ್ತಿ ಮಾಡಿ",
  formsIntro: "ನಿಮ್ಮ ಪ್ರಕರಣದ ನಿಜವಾದ ಫಾರ್ಮ್‌ಗಳು. ಪ್ರತಿಯೊಂದನ್ನು ತೆರೆದು, ಟೈಪ್ ಮಾಡಿ ಅಥವಾ ಮಾತನಾಡಿ ನಿಮ್ಮ ವಿವರಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ — ನಿಮ್ಮ ಫಾರ್ಮ್ ಕೆಳಗೆ ತಕ್ಷಣ ತುಂಬುತ್ತದೆ — ನಂತರ ನೀವೇ ಸಲ್ಲಿಸಿ.",
  fillDetails: "ನಿಮ್ಮ ವಿವರಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ — ಟೈಪ್ ಮಾಡಿ, ಅಥವಾ ಮೈಕ್ ಒತ್ತಿ ಮಾತನಾಡಿ",
  yourForm: "ನಿಮ್ಮ ಫಾರ್ಮ್",
  fillsAsYouType: "(ನೀವು ಟೈಪ್ ಮಾಡುತ್ತಿದ್ದಂತೆ ತುಂಬುತ್ತದೆ)",
  formReady: "— ಸಿದ್ಧ",
  toFill: (n) => `${n} ಭರ್ತಿ ಬಾಕಿ`,
  ready: "ಸಿದ್ಧ",
  fileOnline: "ಆನ್‌ಲೈನ್‌ನಲ್ಲಿ ಸಲ್ಲಿಸಿ",
  printSubmit: "ಮುದ್ರಿಸಿ ಸಲ್ಲಿಸಿ",
  submitYourself: "ನೀವೇ ಸಲ್ಲಿಸಿ — ನಾವು ನಿಮ್ಮ ಪರವಾಗಿ ಕಳುಹಿಸುವುದಿಲ್ಲ:",
  fillOnPortal: "ಅಧಿಕೃತ ಪೋರ್ಟಲ್‌ನಲ್ಲಿ ನಿಜವಾದ ಫಾರ್ಮ್‌ನಲ್ಲಿ ನಿಮ್ಮ ವಿವರಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ:",
  openOfficial: (p) => `${p} ನಲ್ಲಿ ಅಧಿಕೃತ ಫಾರ್ಮ್ ತೆರೆಯಿರಿ`,
  download: "ಭರ್ತಿ ಮಾಡಿದ ಫಾರ್ಮ್ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ",
  printAt: (o) => `ಅದನ್ನು ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ, ಮುದ್ರಿಸಿ, ಸಹಿ ಮಾಡಿ, ಮತ್ತು ${o} ನಲ್ಲಿ ಸಲ್ಲಿಸಿ.`,
  fillFirst: (n) => `ಫಾರ್ಮ್ ಪೂರ್ಣಗೊಳ್ಳಲು ಮೊದಲು ಮೇಲಿನ ${n} ಕ್ಷೇತ್ರಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ.`,
  giveTo: "ಫಾರ್ಮ್ ಅನ್ನು ಯಾರಿಗೆ ಕೊಡಬೇಕು",
  whereSubmit: "ಎಲ್ಲಿ ಸಲ್ಲಿಸಬೇಕು",
  contactLabel: "ಸಂಪರ್ಕ / ಸಹಾಯವಾಣಿ",
  whatNext: "ಮುಂದೆ ಏನಾಗುತ್ತದೆ",
  formsDisclaimer: "ನಾವು ನಿಜವಾದ ಫಾರ್ಮ್ ಭರ್ತಿ ಮಾಡಲು ಸಹಾಯ ಮಾಡುತ್ತೇವೆ; ನೀವೇ ಅದನ್ನು ಅಧಿಕೃತ ಪೋರ್ಟಲ್‌ನಲ್ಲಿ ಅಥವಾ ಕಚೇರಿಯಲ್ಲಿ ಸಲ್ಲಿಸಿ — ಏನೂ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಕಳುಹಿಸಲ್ಪಡುವುದಿಲ್ಲ. ನ್ಯಾಯಾಲಯದಲ್ಲಿ ಸಲ್ಲಿಸುವ ಯಾವುದೇ ದಾಖಲೆಯನ್ನು ಮೊದಲು ಉಚಿತ NALSA ಕಾನೂನು ಸಹಾಯ (ಸಹಾಯವಾಣಿ 15100) ಪರಿಶೀಲಿಸುತ್ತದೆ.",
  helplinesTitle: "ಉಚಿತ ಸಹಾಯವಾಣಿಗಳು — ಒತ್ತಿ ಕರೆ ಮಾಡಿ",
  escTitle: "ಮಾನವ ಪರಿಶೀಲನೆ — ಉಚಿತ NALSA ಕಾನೂನು ಸಹಾಯ",
  eligTitle: "ನೀವು ಉಚಿತ ಕಾನೂನು ಸಹಾಯಕ್ಕೆ ಅರ್ಹರೇ?",
  eligIntro: "ಕಾನೂನು ಸೇವಾ ಪ್ರಾಧಿಕಾರ ಕಾಯ್ದೆ, 1987 ರ ಸೆಕ್ಷನ್ 12 ರ ಅಡಿಯಲ್ಲಿ, ಇವುಗಳಲ್ಲಿ ಯಾವುದಾದರೂ ಒಂದು ನಿಮಗೆ ಅನ್ವಯಿಸಿದರೆ ಕಾನೂನು ಸಹಾಯ ಉಚಿತ:",
  eligGrounds: [
    "ಮಹಿಳೆ ಅಥವಾ ಮಗು",
    "ಪರಿಶಿಷ್ಟ ಜಾತಿ ಅಥವಾ ಪರಿಶಿಷ್ಟ ಪಂಗಡ (SC/ST) ಸದಸ್ಯ",
    "ಅಂಗವಿಕಲ ವ್ಯಕ್ತಿ",
    "ಮಾನವ ಕಳ್ಳಸಾಗಣೆ ಅಥವಾ ಹಿಂಸೆಯ (ಕೌಟುಂಬಿಕ ಹಿಂಸೆ ಸೇರಿ) ಸಂತ್ರಸ್ತ",
    "ಸಾಮೂಹಿಕ ವಿಪತ್ತು, ಜಾತಿ ದೌರ್ಜನ್ಯ, ಪ್ರವಾಹ, ಬರ ಅಥವಾ ಭೂಕಂಪದ ಸಂತ್ರಸ್ತ",
    "ಕೈಗಾರಿಕಾ ಕಾರ್ಮಿಕ",
    "ಬಂಧನ / ರಕ್ಷಣಾ ಗೃಹ / ಬಾಲಗೃಹದಲ್ಲಿರುವ ವ್ಯಕ್ತಿ",
    "ನಿಮ್ಮ ರಾಜ್ಯದ ಆದಾಯ ಮಿತಿಗಿಂತ ಕಡಿಮೆ ವಾರ್ಷಿಕ ಆದಾಯ",
  ],
  eligQuestion: "ಮೇಲಿನವುಗಳಲ್ಲಿ ಯಾವುದಾದರೂ ಒಂದು ನಿಮಗೆ ಅನ್ವಯಿಸುತ್ತದೆಯೇ?",
  eligYes: "ಹೌದು, ಒಂದು ಅನ್ವಯಿಸುತ್ತದೆ",
  eligNo: "ಇಲ್ಲ, ಯಾವುದೂ ಇಲ್ಲ",
  eligibleMsg: "✅ ನೀವು ಉಚಿತ ಕಾನೂನು ಸಹಾಯಕ್ಕೆ ಅರ್ಹರು. ನೋಂದಣಿ ಮಾಡಲು NALSA ಸಹಾಯವಾಣಿ 15100 ಗೆ ಕರೆ ಮಾಡಿ — ನಿಮಗೆ ಉಚಿತವಾಗಿ ವಕೀಲರನ್ನು ನೀಡಲಾಗುತ್ತದೆ.",
  notEligibleMsg: "ನಿಮ್ಮ ಆದಾಯದ ಆಧಾರದ ಮೇಲೆ ನೀವು ಇನ್ನೂ ಅರ್ಹರಾಗಬಹುದು. ಪರಿಶೀಲಿಸಲು ಉಚಿತ NALSA ಸಹಾಯವಾಣಿ 15100 ಗೆ ಕರೆ ಮಾಡಿ — ಕೇಳಲು ಯಾವುದೇ ಶುಲ್ಕವಿಲ್ಲ.",
  eligBadgeLikely: "ಬಹುಶಃ ಅರ್ಹರು",
  eligBadgeCheck: "ಕೆಳಗೆ ಪರಿಶೀಲಿಸಿ",
};

const TABLE: Record<LanguageCode, UIStrings> = { en, hi, bn, ta, te, mr, kn };
